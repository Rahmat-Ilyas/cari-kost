            ...
            <div class="slimscroll-menu" id="remove-scroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="fi-server"></i><span> Data Kost </span> <span class="menu-arrow"></span></a>
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ url('admin/datakost') }}">Semua Kost</a></li>
                                <li><a href="{{ url('admin/kostview') }}">Kost Ditampilkan</a></li>
                                <li><a href="{{ url('admin/kosthide') }}">Kost Disembunyikan</a></li>
                                <li><a href="{{ url('admin/kostdelete') }}">Kost Dihapus</a></li>
                            </ul>
                        </li>

                        <li>
                            <a href="{{ url('admin/dataowner') }}"><i class="fi-head"></i><span> Data Owner </span></a>
                        </li>
                    </ul>
